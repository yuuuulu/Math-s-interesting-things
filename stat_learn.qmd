...
![](images/5c1925776904a7003b6430952f71eb71.jpg){width="642"}
...
where: -$\theta_1, \theta_2$: Population means ((\theta\_1, \theta\_2 \in \mathbb{R}$)
-$\theta\_3 \> 0\$: Common population variance
...
2.  **Derivative w.r.t.**$\theta_3$: The derivative structure is the same as in Step 2.1.3. Substitute$\theta^* = \tilde{\theta}^*$ into the derivative and set to zero: $$
