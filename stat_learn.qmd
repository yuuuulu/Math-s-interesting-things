...
$\thata_{(1)}, \theta_{(2)}, \ldots, \theta_{(B)}$ are the order statistics of $\theta_1, \theta_2, \ldots, \theta_B$.
...
However, in the mathematical proof by contradiction, the conclusion is always correct (the negation is absolutely impossible). But in hypothesis testing, there is a possibility of making errors (almost impossible $H_0$).
...
$H_0$ vs $H_1$. Here, $H_1$ is what we want to prove and $H_0$ is the negation of $H_1$.
