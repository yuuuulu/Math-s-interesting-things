...
Let V and W be two vector spaces and let T ∈ L(V,W) and S ∈ L(W, V ) be such that TS = $Id_W$ . Then V = range(S) ⊕ null(T ) and ST ∈ L(V ) is a projection to range(S) with nullspace null(T).
