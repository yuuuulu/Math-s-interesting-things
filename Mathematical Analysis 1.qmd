...
$$
\lim_{n \to \infty} |h_n(x) - a| = \lim_{n \to \infty} \left| \frac{a}{n} + \frac{x}{n} + \frac{x}{n^2} \right| = 1 \ne 0
$$
...
This series if from former series but wecan also use this method to prove.
...
$$
\Rightarrow |x| \leq M \quad \text{Choose } N(\varepsilon) = \frac{M}{ \frac{\pi}{2}-2}, \text{ when } n \geq N(\varepsilon)
$$

$$
\frac{|x|}{n} \leq \frac{M}{n} \leq \frac{M}{N(\varepsilon)} < \frac{\pi}{2} - 1
$$

$$
1 - \left(\frac{\pi}{2} - 1\right) < 1 + \frac{x}{n} < 1 + \left(\frac{\pi}{2} - 1\right)
$$

$$
2 - \frac{\pi}{2} < 1 + \frac{x}{n} < \frac{\pi}{2}
$$
...
For $\frac{(-1)^n}{\sqrt{n}}$, since it is not convergent, we only need to consider the second part.
